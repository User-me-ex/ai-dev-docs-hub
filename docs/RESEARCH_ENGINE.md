...
> Research Engine: multi-source retrieval, ranking, synthesis, citation, and follow-up planning.
...
- Provide an authoritative specification for Research Engine.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Research Engine without ambiguity.
