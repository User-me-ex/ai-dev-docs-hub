...
> Task graph structure: nodes, edges, artifacts, and execution semantics.
...
- Provide an authoritative specification for Task Graph.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Task Graph without ambiguity.
