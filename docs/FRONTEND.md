...
> Frontend specification: shells (desktop, web, CLI), state model, real-time updates, accessibility.
...
- Provide an authoritative specification for Frontend.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Frontend without ambiguity.
