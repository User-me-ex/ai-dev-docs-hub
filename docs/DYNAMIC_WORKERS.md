...
> Dynamic worker pool: on-demand spawning of specialized agents, lifecycle, autoscaling, and reclamation.
...
- Provide an authoritative specification for Dynamic Workers.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Dynamic Workers without ambiguity.
