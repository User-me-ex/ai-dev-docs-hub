...
> Voice System: STT, TTS, wake words, barge-in, voice profiles, and multi-agent voice routing.
...
- Provide an authoritative specification for Voice System.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Voice System without ambiguity.
