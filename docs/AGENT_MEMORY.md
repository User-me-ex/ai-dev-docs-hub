...
> Per-agent memory model — working set, short-term, long-term, and shared views.
...
- Provide an authoritative specification for Agent Memory.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Agent Memory without ambiguity.
