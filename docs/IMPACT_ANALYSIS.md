...
> Impact Analysis subsystem — predicts blast radius of proposed changes before execution.
...
- Provide an authoritative specification for Impact Analysis.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Impact Analysis without ambiguity.
