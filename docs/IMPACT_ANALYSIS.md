...
> Specification for the change-impact predictor consulted before edits land. This document is normative — implementations MUST satisfy every MUST clause below.
...
- Map every proposed change to affected docs, prompts, and downstream agents.
- Score risk on a 0–1 scale with explanations.
- Feed the Guardian and the Merge Manager.
