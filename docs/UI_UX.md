...
> UI/UX principles, information architecture, key flows, component inventory, and interaction patterns.
...
- Provide an authoritative specification for UI/UX.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about UI/UX without ambiguity.
