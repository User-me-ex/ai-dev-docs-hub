...
> Error taxonomy, propagation, and user-facing messages.
...
- Provide an authoritative specification for Error Handling.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Error Handling without ambiguity.
