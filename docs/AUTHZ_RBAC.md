...
> Authorization and RBAC — roles, permissions, and policy evaluation.
...
- Provide an authoritative specification for Authz RBAC.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Authz RBAC without ambiguity.
