...
> Telemetry policy — what is collected, why, and how to opt out.
...
- Provide an authoritative specification for Telemetry.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Telemetry without ambiguity.
