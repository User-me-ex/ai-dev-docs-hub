...
> Model Context Protocol integration — server discovery, tool exposure, capability negotiation, security.
...
- Provide an authoritative specification for MCP.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about MCP without ambiguity.
