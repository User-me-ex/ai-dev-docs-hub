...
> Symbol Registry — cross-language index of symbols exposed to agents for grounding and refactors.
...
- Provide an authoritative specification for Symbol Registry.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Symbol Registry without ambiguity.
