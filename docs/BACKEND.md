...
> Backend service specification: processes, storage, queues, background jobs, health, and observability.
...
- Provide an authoritative specification for Backend.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Backend without ambiguity.
