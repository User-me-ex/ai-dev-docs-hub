...
> Umbrella spec for the four-tier knowledge system: Global, Main, Group, Individual KBs.
...
- Provide an authoritative specification for Knowledge System.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Knowledge System without ambiguity.
