...
> Prompt governance — versioning, review, evaluation, and rollback of prompts.
...
- Provide an authoritative specification for Prompt Governance.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Prompt Governance without ambiguity.
