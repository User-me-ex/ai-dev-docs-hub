...
> Rate limiting policy across providers and users.
...
- Provide an authoritative specification for Rate Limiting.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Rate Limiting without ambiguity.
