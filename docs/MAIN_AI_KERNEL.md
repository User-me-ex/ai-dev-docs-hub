...
> The Main AI Kernel — central orchestrator that owns routing, scheduling, and coordination of every subsystem.
...
- Provide an authoritative specification for Main Ai Kernel.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Main Ai Kernel without ambiguity.
