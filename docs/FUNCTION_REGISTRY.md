...
> Function Registry — tracked functions, signatures, call graphs, and invariants.
...
- Provide an authoritative specification for Function Registry.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Function Registry without ambiguity.
