...
> Performance targets and profiling methodology.
...
- Provide an authoritative specification for Performance.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Performance without ambiguity.
