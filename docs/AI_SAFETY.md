...
> AI safety controls: content policies, tool-use guards, and human-in-the-loop hooks.
...
- Provide an authoritative specification for Ai Safety.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Ai Safety without ambiguity.
