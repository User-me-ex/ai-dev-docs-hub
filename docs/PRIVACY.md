...
> Privacy posture — local-first defaults, data classification, opt-outs.
...
- Provide an authoritative specification for Privacy.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Privacy without ambiguity.
