...
> Long-term vision for the AI Development Operating System: a self-hostable, model-agnostic, multi-agent OS for building software.
...
- Provide an authoritative specification for Project Vision.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Project Vision without ambiguity.
