...
> Specification for the public and internal API contract. This document is normative — implementations MUST satisfy every MUST clause below.
...
- OpenAPI 3.1 for HTTP, AsyncAPI for WebSocket, JSON Schema for events.
- Semantic versioning with deprecation windows.
- Every endpoint has an error catalog.
...
- `/v1/runs`, `/v1/models`, `/v1/roles`, `/v1/context/*`, `/v1/memory/*`.
