...
> Public and internal API surfaces — HTTP, WebSocket, IPC — with versioning and error contracts.
...
- Provide an authoritative specification for API Spec.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about API Spec without ambiguity.
