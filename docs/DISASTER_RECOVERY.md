...
> Specification for the Disaster Recovery subsystem of the AI Development Operating System. This document is normative — implementations MUST satisfy every MUST clause below.
...
```mermaid
flowchart LR
  IN([Input]) --> SUB[Disaster Recovery]
