...
> Release process — branching, tagging, changelog, distribution.
...
- Provide an authoritative specification for Release Process.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Release Process without ambiguity.
