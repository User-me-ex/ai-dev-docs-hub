...
> RAG pipeline: ingestion, chunking, embedding, retrieval, rerank, and citation.
...
- Provide an authoritative specification for RAG Pipeline.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about RAG Pipeline without ambiguity.
