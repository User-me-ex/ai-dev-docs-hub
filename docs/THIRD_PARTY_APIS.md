...
> Third-party API catalog with contracts and rate limits.
...
- Provide an authoritative specification for Third Party APIs.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Third Party APIs without ambiguity.
