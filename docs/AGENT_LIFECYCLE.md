...
> Agent lifecycle: spawn, warm-up, task, checkpoint, retire, and post-mortem stages.
...
- Provide an authoritative specification for Agent Lifecycle.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Agent Lifecycle without ambiguity.
