...
> Security model: trust boundaries, principals, and enforcement points.
...
- Provide an authoritative specification for Security Model.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Security Model without ambiguity.
