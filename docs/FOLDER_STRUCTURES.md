...
> Canonical folder structures for user projects created and managed by the OS.
...
- Provide an authoritative specification for Folder Structures.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Folder Structures without ambiguity.
