...
> One-page system overview linking every subsystem doc.
...
- Provide an authoritative specification for System Overview.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about System Overview without ambiguity.
