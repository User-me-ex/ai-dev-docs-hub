...
> Command-line interface specification: commands, flags, config, exit codes, scripting patterns.
...
- Provide an authoritative specification for CLI.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about CLI without ambiguity.
