...
> Testing pyramid: unit, integration, agent-eval, end-to-end.
...
- Provide an authoritative specification for Testing Strategy.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Testing Strategy without ambiguity.
