...
> Plugin SDK: extension points, manifest format, sandboxing, capability grants, distribution.
...
- Provide an authoritative specification for Plugin SDK.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Plugin SDK without ambiguity.
