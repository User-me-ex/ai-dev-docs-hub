...
> Catalog of built-in AI Groups (Planner, Builder, Critic, Researcher, Ops) with roles, prompts, and I/O contracts.
...
- Provide an authoritative specification for Ai Groups.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Ai Groups without ambiguity.
