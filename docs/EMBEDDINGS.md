...
> Embedding providers, dimensions, model choice, and normalization.
...
- Provide an authoritative specification for Embeddings.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Embeddings without ambiguity.
