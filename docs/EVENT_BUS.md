...
> Internal event bus — topics, schemas, delivery semantics.
...
- Provide an authoritative specification for Event Bus.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Event Bus without ambiguity.
