...
> Audit log format, storage, retention, and query.
...
- Provide an authoritative specification for Audit Log.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Audit Log without ambiguity.
