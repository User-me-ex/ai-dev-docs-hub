...
> Vector store abstraction: local and remote backends, index types, upsert semantics.
...
- Provide an authoritative specification for Vector Store.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Vector Store without ambiguity.
