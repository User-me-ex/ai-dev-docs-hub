...
> GitHub analysis: repo ingestion, code intelligence, PR review, and history-aware Q&A.
...
- Provide an authoritative specification for Github Analysis.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Github Analysis without ambiguity.
