...
> Inter-process communication: transports, message envelopes, request/response and pub/sub semantics.
...
- Provide an authoritative specification for IPC.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about IPC without ambiguity.
