...
> Authentication system — local accounts, SSO, device trust, and session management.
...
- Provide an authoritative specification for Auth System.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Auth System without ambiguity.
