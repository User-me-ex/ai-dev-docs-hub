...
> Architecture Guardian — enforces architectural invariants and rejects changes that break contracts.
...
- Provide an authoritative specification for Architecture Guardian.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Architecture Guardian without ambiguity.
