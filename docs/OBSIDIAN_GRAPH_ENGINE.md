...
> Obsidian-compatible knowledge graph engine: markdown-first storage, backlinks, tags, graph queries.
...
- Provide an authoritative specification for Obsidian Graph Engine.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Obsidian Graph Engine without ambiguity.
