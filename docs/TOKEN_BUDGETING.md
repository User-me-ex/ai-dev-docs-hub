...
> Token budgeting policy across sessions, roles, and providers.
...
- Provide an authoritative specification for Token Budgeting.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Token Budgeting without ambiguity.
