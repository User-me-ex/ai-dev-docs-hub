...
- `discover(provider) → Model[]`
- `refresh_all() → DiscoveryReport`
...
- `DiscoveryReport { ts, providers[], added[], removed[], errors[] }`.
...
- Malformed response → skip provider, raise an alert, keep last known good.
