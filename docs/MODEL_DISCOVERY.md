...
> How /models discovery works across providers, normalization schema, capability inference, caching, refresh triggers.
...
- Provide an authoritative specification for Model Discovery.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Model Discovery without ambiguity.
