...
> Agent-to-agent communication protocols, envelopes, and conversation patterns.
...
- Provide an authoritative specification for Agent Communication.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Agent Communication without ambiguity.
