...
> Job Scheduler: cron, one-shot, and event-triggered jobs with idempotency guarantees.
...
- Provide an authoritative specification for Job Scheduler.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Job Scheduler without ambiguity.
