...
> Product Requirements Document. Personas, jobs-to-be-done, feature list, priorities, success metrics, release milestones.
...
- Provide an authoritative specification for PRD.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about PRD without ambiguity.
