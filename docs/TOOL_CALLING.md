...
> Tool calling protocol shared by all agents: schema, validation, sandboxing, retries.
...
- Provide an authoritative specification for Tool Calling.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Tool Calling without ambiguity.
