...
> Deployment topologies: single-user, team, self-hosted, hybrid.
...
- Provide an authoritative specification for Deployment.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Deployment without ambiguity.
