...
> Secrets management — providers, rotation, and scoping.
...
- Provide an authoritative specification for Secrets Management.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Secrets Management without ambiguity.
