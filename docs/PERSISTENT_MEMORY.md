...
> Persistent memory subsystem — episodic, semantic, and procedural memory with retention and eviction rules.
...
- Provide an authoritative specification for Persistent Memory.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Persistent Memory without ambiguity.
