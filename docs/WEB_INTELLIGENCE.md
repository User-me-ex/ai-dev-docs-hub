...
> Web intelligence layer combining search, fetching, extraction, and long-running monitoring.
...
- Provide an authoritative specification for Web Intelligence.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Web Intelligence without ambiguity.
