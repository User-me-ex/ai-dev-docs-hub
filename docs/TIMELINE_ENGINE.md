...
> Timeline Engine — event-sourced project timeline that all agents read from and append to.
...
- Provide an authoritative specification for Timeline Engine.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Timeline Engine without ambiguity.
