...
> Architecture of the AI Project OS layer: workspaces, projects, sessions, artifacts, and lifecycle events.
...
- Provide an authoritative specification for Project OS.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Project OS without ambiguity.
