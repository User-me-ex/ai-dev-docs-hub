...
> First-party integrations catalog.
...
- Provide an authoritative specification for Integrations.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Integrations without ambiguity.
