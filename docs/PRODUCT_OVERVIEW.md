...
> High-level product summary — target users, core value proposition, key surfaces (CLI, desktop, web), and differentiators.
...
- Provide an authoritative specification for Product Overview.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Product Overview without ambiguity.
