...
> Database schema and access patterns: entities, relations, migrations, indexing strategy.
...
- Provide an authoritative specification for Database.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Database without ambiguity.
