...
> Reasoning trace capture, storage, and replay for debugging and evaluation.
...
- Provide an authoritative specification for Reasoning Traces.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Reasoning Traces without ambiguity.
