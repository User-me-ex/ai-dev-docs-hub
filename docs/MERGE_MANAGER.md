...
> Merge Manager: how conflicting agent edits are reconciled — three-way merges, semantic diffs, human review.
...
- Provide an authoritative specification for Merge Manager.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Merge Manager without ambiguity.
