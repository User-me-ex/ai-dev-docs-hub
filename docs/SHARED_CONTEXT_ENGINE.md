...
> Shared Context Engine — how agents publish, subscribe to, and version shared state across a session.
...
- Provide an authoritative specification for Shared Context Engine.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Shared Context Engine without ambiguity.
