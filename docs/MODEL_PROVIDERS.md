...
> Supported model providers (OpenAI, Anthropic, Mistral, Google, Ollama, local) — auth, capabilities, quirks.
...
- Provide an authoritative specification for Model Providers.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Model Providers without ambiguity.
