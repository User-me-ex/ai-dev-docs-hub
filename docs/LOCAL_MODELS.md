...
> Running local models via Ollama, llama.cpp, and MLX.
...
- Provide an authoritative specification for Local Models.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Local Models without ambiguity.
