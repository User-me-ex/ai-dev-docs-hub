...
> Security overview and threat surface summary.
...
- Provide an authoritative specification for Security.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Security without ambiguity.
