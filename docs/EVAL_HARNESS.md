...
> Evaluation harness for prompts, agents, and end-to-end flows.
...
- Provide an authoritative specification for Eval Harness.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Eval Harness without ambiguity.
