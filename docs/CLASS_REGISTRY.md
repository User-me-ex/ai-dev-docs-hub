...
> Class Registry — tracked classes/types with owners, invariants, and dependency edges.
...
- Provide an authoritative specification for Class Registry.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Class Registry without ambiguity.
