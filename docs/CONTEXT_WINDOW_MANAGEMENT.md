...
> How the kernel budgets, compacts, and evicts context to stay within model windows.
...
- Provide an authoritative specification for Context Window Management.
- Define contracts, invariants, and acceptance criteria.
- Enable AI agents to reason about Context Window Management without ambiguity.
